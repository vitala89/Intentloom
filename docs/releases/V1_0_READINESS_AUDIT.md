...
Candidate baseline under review: `802da40` (`main` and `origin/main` after PR
#129 merge). The release gate remains open until the decisions and evidence in
...
runtime-equivalent candidate tree. The post-merge run for `802da40` passed all
...
| Supported Node/host/provider matrix                          | PASS                | [COMPATIBILITY_MATRIX.md](../compatibility/COMPATIBILITY_MATRIX.md); post-merge run [30496928912](https://github.com/vitala89/Intentloom/actions/runs/30496928912) for `802da40` passed all six Ubuntu, macOS, and Windows Node 22/24 jobs              |
...
the previous `main` candidate `2c7d4a4` passed post-merge in [run
30495322242](https://github.com/vitala89/Intentloom/actions/runs/30495322242), and
the current `main` candidate `802da40` passed post-merge in [run
30496928912](https://github.com/vitala89/Intentloom/actions/runs/30496928912).
...
the exact approved release commit `802da40` or authorize a fresh run.
...
3. Local release-candidate install, build, packed CLI smoke, and full validation
   ...
   approved commit `802da40`, or authorize a fresh run.
