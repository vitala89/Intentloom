...
| Supported Node/host/provider matrix                          | PASS                | [COMPATIBILITY_MATRIX.md](../compatibility/COMPATIBILITY_MATRIX.md); post-merge run [30498583852](https://github.com/vitala89/Intentloom/actions/runs/30498583852) for `3257bdf` passed all six Ubuntu, macOS, and Windows Node 22/24 jobs              |
...
the current `main` candidate `3257bdf` passed post-merge in [run
30498583852](https://github.com/vitala89/Intentloom/actions/runs/30498583852).
...
the exact approved release commit `3257bdf` or authorize a fresh run.
...
3. Local release-candidate install, build, packed CLI smoke, and full validation
   ...
   approved commit `3257bdf`, or authorize a fresh run.
