...
The public package is `intentloom`; the workspace is preparing prerelease
`0.5.0-beta.1`, while npm `next` still serves the published `0.4.0-beta.1`
artifact.
...
| `v0.5.0-beta.1`                    | **Engineering Process Intelligence increment**: Workflow variants, observed duration metrics, conformance trends, deterministic repetition summaries, and observed transition intervals.                                                                                                                                                                                                                  | Release preparation in progress; not published |
