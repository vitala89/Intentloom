...
| :--------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------- |
| `v0.1.0-alpha.x` / `v0.1.0-beta.1` | Core platform foundation, adoption engine, CLI framework, basic adapters, provider synchronization (`sync`/`diff`).                                                                                                                                                                                                                                                                                       | Published (`npm latest` / `next`) |
| `v0.2.0-beta.1`                    | 3-way pack update migration (`update`), engineering conformance profiles, initial extension lifecycle ADRs.                                                                                                                                                                                                                                                                                               | Published (`npm latest` / `next`) |
| `v0.3.0-beta.1`                    | Engineering Conformance Engine (CLI/MCP), Managed Extension Lifecycle specification & schemas (`urn:aif:schema:extension-manifest:1`).                                                                                                                                                                                                                                                                    | Published (`npm latest` / `next`) |
| `v0.4.0-beta.1`                    | **Controlled Agent Learning & Procedural Memory Milestone (Candidates L1–L8 Complete)**: Task summaries (`summary`), skill discovery (`discover`), proposal lifecycle (`proposal`), evaluation regression gates (`evaluate`), memory inspection & mutation plans (`memory`), checkpoints & task control (`checkpoint`), semantic ranking (`rank`), profile isolation & delegation (`profile`/`delegate`). | **Next Immediate Release**        |
| `v0.5.0-beta.1`                    | **Memory & Security Milestone (Candidates M1–M4, S1–S2)**: Bounded project context (`context`), persistent memory, semantic retrieval adapters, session lifecycle, security evidence posture, and local security adapters.                                                                                                                                                                                | Future Candidate Milestone        |
