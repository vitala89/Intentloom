...
The public package is `intentloom`; workspace version `0.5.0-beta.1` is
...
| `v0.5.0-beta.1`                    | **Engineering Process Intelligence increment**: Workflow variants, observed duration metrics, conformance trends, deterministic repetition summaries, and observed transition intervals.                                                                                                                                                                                                                  | Published (`npm next`)             |
