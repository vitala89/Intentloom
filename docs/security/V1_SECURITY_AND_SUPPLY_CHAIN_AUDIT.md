...
| **Dependency Governance** | pnpm lockfile reproducibility, zero unvetted runtime dependencies                       | ✅ PASS             | `pnpm-lock.yaml`, `package.json`                                              |
...
2. **Dependency Auditing**: `pnpm audit` is integrated into CI workflows to prevent inclusion of vulnerable third-party packages.
