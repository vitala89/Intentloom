...
| ----- | ------------------------------------------------------------------------------------ | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P4l1  | `mutation-outcome.ts`, `project-command-context.ts`, `governance-adoption-format.ts` | **complete** | Shared mutation/sync outcome mapping, project bootstrap context, governance plan formatting; no command early dispatch; `command.ts` still owns init/adopt/update/sync/plan routing |
...
| P4l3+ | init / adopt / sync / plan / update (planned)                                        | not started  | Per-command extraction after diff                                                                                                                                                   |

1. **`init` / `adopt` / `sync` / `plan` / `update`** — remaining mutation
   commands; one family per PR after diff (P4l3 plan is next).
