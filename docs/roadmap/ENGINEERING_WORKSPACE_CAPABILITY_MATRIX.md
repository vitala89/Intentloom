...
| Adoption plan / apply                         | implemented | adoption contracts                            | yes       | read-only plan/decisions/prepare/revalidate RPCs; apply still `APPROVED_APPLY` / CLI | `adopt`, `update`                        | preview + decisions + prepared-plan summary | partial                 | partial                               | `integration-pending` | Prepared envelope is read-only; Desktop apply not started                                                                                                         |
