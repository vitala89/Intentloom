...
| I6 Transactional apply       | `applyFoundationProjectScaffold`, `rollbackFoundationProjectScaffold` (wrap I6)                                | `foundation-scaffold-apply.test.ts`    | foundation apply/rollback RPC | CLI `scaffold-apply`/`scaffold-rollback` | W7 Core on branch; Client pending          | Foundation gate + revalidation; Desktop/TUI in W7 Client                    |
...
| **W7**  | Transactional empty-root creation                                                          | I6 app ops exist; W7 Core in progress on branch                     | `core-first` Core PR; Client follows Core merge     |
