...
| I7 Library workspace starter | workspace scaffold helpers + invariants                                                                        | `inception-workspace-scaffold.test.ts`, `foundation-scaffold-workspace.test.ts` | **none**                      | **none**                                 | W8 Core in progress                             | Expanded W8 shape: core/react/testing/examples                              |
...
| **W8**  | Library ecosystem starter and dogfooding                                                   | W8 Core in progress on branch                                       | `core-first` Core PR; Client follows Core           |
