...
import { INTENTLOOM_VERSION } from "./version.js";
export { INTENTLOOM_VERSION };
...
export function generatedHeader(
  ...
  return [
    `${comment} Generated by Intentloom ${INTENTLOOM_VERSION}; do not edit manually.`,
...
export function parseAifConfig(value: string): AifConfig {
  ...
  if (
    ...
    throw new Error("config does not satisfy Intentloom schema version 1");
  }
