...
import { formatAdoptionProposal } from "./formatters.js";
import { parseAdoptArguments } from "./adopt-parse.js";
import {
  buildProjectMutationOptions,
  loadInvalidProjectMetadata,
} from "./project-command-context.js";

export type AdoptCliExitCode = 0 | 2 | 3 | 4 | 5;
...
export interface AdoptCliDependencies {
...
export async function runAdoptCommand(
  ...
  dependencies: AdoptCliDependencies,
  io: AdoptCliIo,
): Promise<AdoptCliExitCode> {
  const parsed = parseAdoptArguments(args);
