...
- PR #84 through PR #124 are merged in the local history; current `main` is
  verified at `484fcb4` and tracks `origin/main`.
...
- The post-merge Compatibility run for `main` at `484fcb4` passed all six
