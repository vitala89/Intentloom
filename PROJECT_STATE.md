...
- PR #84 through PR #123 are merged in the local history; current `main` is
  verified at `840989a` and tracks `origin/main`.
...
- The post-merge Compatibility run for `main` at `840989a` passed all six
