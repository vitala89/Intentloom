...
- Engineering Quality Packs phases Q1–Q4 are implemented, verified, and merged
  ...
  focused Windows Node 22 CI timeout fix is prepared locally after the initial
  remote run exceeded Vitest's 30-second preparation-hook limit; remote rerun,
