...
- PR #84 through PR #120 are merged in the local history; current `main` is
  verified at `d076c037` and tracks `origin/main`.
...
- The post-merge Compatibility run for `main` at `d076c037` passed all six
