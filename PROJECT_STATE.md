...
1. Land Specialized Engineering Packs Phase S7 on branch
   `feat/specialized-packs-s7-deterministic-checks` (commit, PR, merge) and continue with Phase S8 reviewed external packs.
