...
- PR #84 through PR #125 are merged in the local history; current `main` is
  verified at `d750acf` and tracks `origin/main`.
...
- The post-merge Compatibility run for `main` at `d750acf` passed all six
