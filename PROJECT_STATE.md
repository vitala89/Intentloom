...
1. Open PR for Specialized Engineering Packs Phase S5 on branch
   `feat/specialized-packs-s5-first-party-packs` after atomic commit and CI review.
2. Keep GitHub Pages as the canonical public documentation destination and
