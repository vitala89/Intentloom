...
- PR #84 through PR #112 are merged in the local history; current `main` is
  verified at `5d1af7c` and tracks `origin/main`.
...
- The post-merge Compatibility run for `main` at `5d1af7c` passed all six
