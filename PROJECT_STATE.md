...
1. Land Specialized Engineering Packs Phase S6 on branch
   `feat/specialized-packs-s6-client-surfaces` (commit, PR, merge) and continue with Phase S7 deterministic checks.
