...
| `v0.5.0-beta.1` | Engineering Process Intelligence increment                               | Workflow variants, durations, conformance trends, repetition, and transition intervals                                  | Readiness audit in progress; implemented in `main` at `f546b76`, not yet released to npm      |
