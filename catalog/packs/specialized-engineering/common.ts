export const FIRST_PARTY_PUBLISHER = "intentloom-first-party" as const;

export const FIRST_PARTY_ALIAS_CREATED_AT = "2026-08-10T12:00:00.000Z" as const;

// Keep aligned with `@intentloom/protocol` engineering-quality schema URNs.
